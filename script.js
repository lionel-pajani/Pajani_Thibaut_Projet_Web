...
function final(demo)
{
	if(points <= 0)
	{
		document.getElementById(demo).innerHTML = "Vous avez "+ points +" points. Dommage ! Informez-vous davantage sur les réflexes écologiques à adopter.";
	}
	else if (1 <= points < 3)
	{
		document.getElementById(demo).innerHTML = "Vous avez "+ points +" points. Vous êtes sur la bonne voie, continuez à développer les bons réflexes écologiques !";
	}
	else if (points >= 3)
	{
		document.getElementById(demo).innerHTML = "Vous avez "+ points +" points. Bravo ! Vous avez adopté les bons rélflexes écologiques !";
	}
	points = 0;
}
/*-----------------------CAROUSSEL-------------------*/
